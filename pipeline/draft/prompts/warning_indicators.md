...
| wi-07 | Nuclear facility attack | d2 | AP or IAEA confirms a strike on a declared or suspected Iranian nuclear site (Natanz, Fordow, Arak, Isfahan) | Damage assessment published by IAEA; no further strikes confirmed within 72h |
...
| wi-11 | PKK attack on Turkish energy or NATO infrastructure | d3 / d4 | AP or Reuters confirms a PKK strike on Kirkuk-Ceyhan pipeline infrastructure, Incirlik airbase, or a named Turkish NATO installation — not routine PKK rural operations | Damaged infrastructure confirmed restored; no further confirmed PKK attacks on NATO-relevant assets within 72h |
| wi-12 | Canadian assets directly at risk | d1 / d6 | Global Affairs Canada (GAC) confirms Canadian nationals in an active strike zone, Canadian-flagged vessel interdicted, or CSIS advisory issued for Canadian commercial entities in theatre | GAC/Transport Canada confirms threat resolved |
